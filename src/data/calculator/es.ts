...
export const esPedagogy: Record<string, CalculatorPedagogyData> = {
  scientific: {
    ...
    conceptDescription: [
      ...
      'Los microprocesadores modernos realizan cálculos de punto flotante usando el estándar IEEE 754 para doble precisión binaria (float64). Dado que ciertas fracciones en base 10 (como 0.1 o 0.2) tienen expansiones periódicas en binario de base 2, la aritmética binaria directa introduce pequeñas discrepancias de redondeo (ej. 0.1 + 0.2 = 0.30000000000000004). SciCalcX aplica normalización basada en épsilon para reducir los artefactos comunes de representación en coma flotante en los resultados mostrados de hasta 12 decimales.',
