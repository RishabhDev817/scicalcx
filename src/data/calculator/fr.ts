...
export const frPedagogy: Record<string, CalculatorPedagogyData> = {
  scientific: {
    ...
    conceptDescription: [
      ...
      'Les microprocesseurs actuels exécutent les calculs en virgule flottante selon la norme IEEE 754 pour la double précision binaire (float64). Comme certaines fractions décimales (comme 0.1 ou 0.2) ont un développement infini en binaire, l\'arithmétique brute introduit d\'infimes écarts d\'arrondi (ex. 0.1 + 0.2 = 0.30000000000000004). SciCalcX applique une normalisation basée sur un seuil epsilon pour réduire les artefacts usuels de représentation en virgule flottante dans les résultats affichés jusqu\'à 12 décimales.',
